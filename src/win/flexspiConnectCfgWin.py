...
# Form implementation generated from reading ui file 'D:\github_repo_jay\MCU-MemTestUtility\gui\FlexSPI-Connection-Configuration.ui'
#
...
class Ui_flexspiConnCfgDialog(object):
    def setupUi(self, flexspiConnCfgDialog):
        ...
        flexspiConnCfgDialog.resize(419, 388)
        ...
        self.label_dqs0 = QtWidgets.QLabel(flexspiConnCfgDialog)
        ...
        self.comboBox_sclk.addItem("")
        self.comboBox_sclk.addItem("")
        self.comboBox_dqs0 = QtWidgets.QComboBox(flexspiConnCfgDialog)
        ...
        self.comboBox_dataT8b = QtWidgets.QComboBox(flexspiConnCfgDialog)
        ...
        self.label_dataT8b = QtWidgets.QLabel(flexspiConnCfgDialog)
        ...
        self.label_dqs1 = QtWidgets.QLabel(flexspiConnCfgDialog)
        ...
        self.comboBox_dqs1 = QtWidgets.QComboBox(flexspiConnCfgDialog)
    ...
    def retranslateUi(self, flexspiConnCfgDialog):
        ...
        self.label_dqs0.setText(_translate("flexspiConnCfgDialog", "DQS/RWDS0:"))
        ...
        self.comboBox_dqs0.setItemText(0, _translate("flexspiConnCfgDialog", "PortA_DQS - GPIO_SD_B2[5]"))
        self.comboBox_dqs0.setItemText(1, _translate("flexspiConnCfgDialog", "PortA_DQS - GPIO_AD[17]"))
        self.comboBox_dqs0.setItemText(2, _translate("flexspiConnCfgDialog", "PortA_DQS - GPIO_EMC_B2[18]"))
        self.comboBox_dqs0.setItemText(3, _translate("flexspiConnCfgDialog", "PortB_DQS - GPIO_SD_B1[5]"))
        ...
        self.comboBox_dataT8b.setItemText(0, _translate("flexspiConnCfgDialog", "None"))
        self.label_dataT8b.setText(_translate("flexspiConnCfgDialog", "DATA_T8B:"))
        self.label_dqs1.setText(_translate("flexspiConnCfgDialog", "DQS/RWDS1:"))
        self.comboBox_dqs1.setItemText(0, _translate("flexspiConnCfgDialog", "None"))
