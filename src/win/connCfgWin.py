...
class Ui_connCfgDialog(object):
    def setupUi(self, connCfgDialog):
        ...
        self.lineEdit_padCtrlSsb = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlSsb.setGeometry(QtCore.QRect(420, 140, 81, 20))
        self.lineEdit_padCtrlSsb.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlSsb.setObjectName("lineEdit_padCtrlSsb")
        self.lineEdit_padCtrlSclk = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlSclk.setGeometry(QtCore.QRect(420, 170, 81, 20))
        self.lineEdit_padCtrlSclk.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlSclk.setObjectName("lineEdit_padCtrlSclk")
        self.lineEdit_padCtrlSclkn = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlSclkn.setGeometry(QtCore.QRect(420, 200, 81, 20))
        self.lineEdit_padCtrlSclkn.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlSclkn.setObjectName("lineEdit_padCtrlSclkn")
        self.lineEdit_padCtrlDqs0 = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlDqs0.setGeometry(QtCore.QRect(420, 230, 81, 20))
        self.lineEdit_padCtrlDqs0.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlDqs0.setObjectName("lineEdit_padCtrlDqs0")
        self.lineEdit_padCtrlDqs1 = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlDqs1.setGeometry(QtCore.QRect(420, 260, 81, 20))
        self.lineEdit_padCtrlDqs1.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlDqs1.setObjectName("lineEdit_padCtrlDqs1")
        self.lineEdit_padCtrlRstb = QtWidgets.QLineEdit(connCfgDialog)
        self.lineEdit_padCtrlRstb.setGeometry(QtCore.QRect(420, 290, 81, 20))
        self.lineEdit_padCtrlRstb.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_padCtrlRstb.setObjectName("lineEdit_padCtrlRstb")
