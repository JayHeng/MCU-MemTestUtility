...
class Ui_memTesterWin(object):
    def setupUi(self, memTesterWin):
        ...
        self.pushButton_memRegs.setGeometry(QtCore.QRect(470, 10, 81, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textEdit_displayWin.setGeometry(QtCore.QRect(10, 50, 451, 81))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.pushButton_perfTest.setGeometry(QtCore.QRect(290, 10, 81, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_stressTest.setGeometry(QtCore.QRect(380, 10, 81, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_rwTest.setGeometry(QtCore.QRect(200, 10, 81, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textEdit_displayWinReg = QtWidgets.QTextEdit(self.dispFrame)
        self.textEdit_displayWinReg.setGeometry(QtCore.QRect(470, 50, 241, 81))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.textEdit_displayWinReg.setFont(font)
        self.textEdit_displayWinReg.setFrameShadow(QtWidgets.QFrame.Plain)
        self.textEdit_displayWinReg.setReadOnly(True)
        self.textEdit_displayWinReg.setObjectName("textEdit_displayWinReg")
        self.textEdit_displayWinTest = QtWidgets.QTextEdit(self.dispFrame)
        self.textEdit_displayWinTest.setGeometry(QtCore.QRect(10, 140, 701, 81))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.textEdit_displayWinTest.setFont(font)
        self.textEdit_displayWinTest.setFrameShadow(QtWidgets.QFrame.Plain)
        self.textEdit_displayWinTest.setReadOnly(True)
        self.textEdit_displayWinTest.setObjectName("textEdit_displayWinTest")
        ...
        self.menu_showCmdPacket = QtWidgets.QMenu(self.menuTools)
        self.menu_showCmdPacket.setObjectName("menu_showCmdPacket")
        ...
        self.menuShowCmdPacket_No = QtWidgets.QAction(memTesterWin)
        ...
        self.menuShowCmdPacket_Yes = QtWidgets.QAction(memTesterWin)
        ...
        self.menu_showCmdPacket.addAction(self.menuShowCmdPacket_No)
        self.menu_showCmdPacket.addAction(self.menuShowCmdPacket_Yes)
        self.menuTools.addAction(self.menu_loadFirmware.menuAction())
        self.menuTools.addAction(self.menu_showCmdPacket.menuAction())
    ...
    def retranslateUi(self, memTesterWin):
        ...
        self.menu_showCmdPacket.setTitle(_translate("memTesterWin", "Show Cmd Packet"))
        ...
        self.menuShowCmdPacket_No.setText(_translate("memTesterWin", "No"))
        self.menuShowCmdPacket_Yes.setText(_translate("memTesterWin", "Yes - For Debug"))
